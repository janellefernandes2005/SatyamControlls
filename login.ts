...
class LoginHandler {
    ...
    private currentStep: 'login' | 'otp' = 'login';
    ...
    private init(): void {
        ...
        if (form) {
            ...
            if (usernameInput) usernameInput.autocomplete = 'username';
    ...
    private async handleLogin(event: Event): Promise<void> {
        ...
        const errorDiv = document.getElementById('error') as HTMLElement; // Updated to match HTML ID
    ...
    private showOTPModal(debugOTP?: string, message?: string): void {
        const modalHTML = `
    ...
    private async verifyOTP(): Promise<void> {
        ...
        const verifyBtn = document.getElementById('verifyOTP') as HTMLButtonElement;
